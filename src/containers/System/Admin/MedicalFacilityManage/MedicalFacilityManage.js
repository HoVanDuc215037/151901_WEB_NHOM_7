...
class MedicalFacilityManage extends Component {
    ...
    handleFacilityImageChange = async (event) => {
        ...
        let file = data[0];
        if (file) {
            let base64 = await CommonUtils.getBase65(file);
    ...
    handleSaveMedicalFacilityInformation = async () => {
        ...
        try {
            ...
            console.log("Data sent to API:",saveFacilityRes);

            if (saveFacilityRes.errCode === 0) {
                toast.success("Tạo Cơ sở Y tế thành công!");
            } else {
                toast.error(saveFacilityRes.ereMessage || "Đã xảy ra lỗi. Vui lòng thử lại.");
            }
            console.log(saveFacilityRes.ereMessage);
        } catch (error) {
                            ...
                            <div className="row row-in-form">
                                <div className="col-md-6 mb-3">
                                    ...
                                    <input
                                        ...
                                        value={this.state.medicalFacilityName}
                                    />
                                </div>
                                <div className="col-md-6 mb-3">
